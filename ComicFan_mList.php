...
//include('./php/DBHelper.class.php');
//$helper=new DBHelper();
//$all_mlist=$helper->queryObjListBySql("SELECT * FROM comic_list");
...
<!--返回顶部-->
<a id="scrollUp" href="#mlist" style="position: fixed; z-index: 2147483647; display: block;">
